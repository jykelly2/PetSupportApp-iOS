...
class FavoriteVC: UIViewController {
    ...
    func setData(){
        ...
        let pet = FavModel(tilte: FAVORITE_TYPE.Pet.rawValue)
        pet.isSelect = true
        self.FavTypeArray.append(pet)
        self.FavTypeArray.append(FavModel(tilte: FAVORITE_TYPE.Shelter.rawValue))
...
extension FavoriteVC{
    ...
    func setPageViewController(){
        ...
        let past : FavoritePetListVC = self.storyboard?.instantiateViewController(withIdentifier: "FavoritePetListVC") as! FavoritePetListVC
       // past.rideType = .Past
        self.arrViewController.append(past)
        
        let schedule : FavoriteShelterListVC = self.storyboard?.instantiateViewController(withIdentifier: "FavoriteShelterListVC") as! FavoriteShelterListVC
